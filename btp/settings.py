...
SECRET_KEY = 'django-insecure-zy5p)^blae)mm=ri3b5n$p98m##o=deyv-!c_ju5m3)5jdl!&v'
...
CORS_ORIGIN_ALLOW_ALL = True  # Set to False to specify specific origins
CORS_ALLOW_HEADERS = [
    'Content-Type',
    'Authorization',
]  # Add any additional headers that you want to allow
